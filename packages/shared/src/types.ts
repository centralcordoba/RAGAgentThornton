...
export type CalendarEventStatus = 'PENDING' | 'IN_PROGRESS' | 'COMPLETED' | 'OVERDUE';
...
export interface CalendarEvent {
  ...
  readonly obligationId: string | null;
  readonly regulatoryChangeId: string | null;
...
export interface CalendarSummary {
  ...
  readonly byCountry: readonly { readonly country: string; readonly count: number }[];
  readonly byType: readonly { readonly type: CalendarEventType; readonly count: number }[];
}

// ---------------------------------------------------------------------------
// Impact Analyzer (Phase 8)
// ---------------------------------------------------------------------------
...
export interface ImpactReport {
  ...
  readonly diff: {
    ...
    readonly changedClauses: readonly ChangedClause[];
  };
...
export interface ChangedClause {
  ...
  readonly title: string;
  readonly changeType: 'deadline_shortened' | 'new_obligation' | 'sanction_increased' | 'exception_removed' | 'definition_changed';
...
export interface ReasoningStep {
  ...
  readonly type: 'search' | 'analysis' | 'graph' | 'detection' | 'clients' | 'complete' | 'warning';
  readonly message: string;
...
export interface ClientImpact {
  ...
  readonly deadlineChange: { readonly from: string; readonly to: string } | null;
  readonly recommendedAction: string;
}

export interface RecommendedAction {
  readonly priority: 'immediate' | 'short_term' | 'medium_term';
  readonly action: string;
  readonly deadline: string | null;
  readonly assignTo: 'client' | 'gt_professional';
}
...
export interface TimelinePoint {
  ...
  readonly changes: readonly { readonly id: string; readonly title: string; readonly impactLevel: ImpactLevel }[];
}
